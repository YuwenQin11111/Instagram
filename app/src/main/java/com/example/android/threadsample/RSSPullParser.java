...
import com.example.android.threadsample.DisplayActivity.Video;
...
public class RSSPullParser extends DefaultHandler {
    ...
    // A string that will contain next url
    ...
    /**
     * A getter that returns the next pagination url
     * @return A url string containing the next url
     */
    ...
    public void parseXml(InputStream inputStream,
    	...
    	mNextUrl = paginationJsonObject.getString("next_url");
    ...
    public List<Video> parseXmlVideo(InputStream inputStream) 
