...
import com.example.android.threadsample.MainLayout;
...
public class DisplayActivity extends FragmentActivity implements OnBackStackChangedListener {
	...
	private void onMenuItemClick(AdapterView<?> parent, View view,
		...
		FragmentManager fm = DisplayActivity.this.getSupportFragmentManager();
		FragmentTransaction ft = fm.beginTransaction();
		Fragment fragment = null;

		if (selectedItem.compareTo("Video") == 0) {
			fragment = new VideoFragment();
		} else if (selectedItem.compareTo("Image") == 0) {
			fragment = new PhotoThumbnailFragment();
		}
    ...
    public void onCreate(Bundle stateBundle) {
        ...
        displayerIntentFilter.addDataScheme("https");
